...
// ========================================
// FORGOT PASSWORD HANDLER - NODE.JS API WITH EMAIL
// ========================================
...
document.getElementById('forgotPasswordForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Log jika ada OTP testing (fallback)
            if (data.data && data.data.otp_for_testing) {
                console.log('🔑 OTP (fallback):', data.data.otp_for_testing);
            }
            
            setTimeout(showVerifyOtp, 3000);
        ...
        showError('Koneksi gagal! Pastikan Node.js server berjalan di port 2011.');
    }
});

// ========================================
// VERIFY OTP HANDLER - NODE.JS API
// ========================================
...
// ========================================
// RESET PASSWORD HANDLER - NODE.JS API
// ========================================
